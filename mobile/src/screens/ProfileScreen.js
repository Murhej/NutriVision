...
export default function ProfileScreen({ navigation }) {
  ...
  const { profile: USER_PROFILE, achievements: ACHIEVEMENTS } = data;
  ...
  const settingsItems = [
    ...
    { icon: <Ruler size={20} color={colors.textSecondary} />, label: 'Units', detail: USER_PROFILE.unitSystem || 'Metric', toggle: false },
  ];
